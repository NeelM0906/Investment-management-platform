...
describe('DealRoomService', () => {
  ...
  describe('getDealRoomByProjectId', () => {
    ...
    it('should throw error for invalid project ID', async () => {
      ...
      await expect(dealRoomService.getDealRoomByProjectId(null as any)).rejects.toThrow('Project ID is required');
    });
  });

  describe('createDealRoom', () => {
    it('should create deal room with valid data', async () => {
      const createData: DealRoomCreateData = {
    ...
    it('should throw error for invalid data', async () => {
      ...
      await expect(dealRoomService.createDealRoom(invalidData as any)).rejects.toThrow('Validation failed');
    });
  ...
  describe('uploadShowcasePhoto', () => {
    ...
    it('should throw error for file too large', async () => {
      const projectId = 'project-123';
      const file = Buffer.alloc(11 * 1024 * 1024); // 11MB
      const originalName = 'photo.jpg';
      const mimeType = 'image/jpeg';
