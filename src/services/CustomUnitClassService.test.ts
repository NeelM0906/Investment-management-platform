import { CustomUnitClassService } from './CustomUnitClassService';
import { CustomUnitClass, CustomUnitClassFormData, ICustomUnitClassRepository } from '../types';

// Mock repository
class MockCustomUnitClassRepository implements ICustomUnitClassRepository {
  private classes: CustomUnitClass[] = [];
  private nextId = 1;
  ...
  getAll(): CustomUnitClass[] {
    return [...this.classes];
  }
}

describe('CustomUnitClassService', () => {
  let service: CustomUnitClassService;
  let mockRepository: MockCustomUnitClassRepository;
  ...
  beforeEach(() => {
    ...
    service = new CustomUnitClassService(mockRepository);
  });
  ...
  describe('error handling', () => {
    it('should handle repository errors gracefully', async () => {
      ...
      const errorService = new CustomUnitClassService(errorRepository);
