...
import { DebtEquityClassService } from '../services/DebtEquityClassService';
import { CustomUnitClassService } from '../services/CustomUnitClassService';
...
describe('Debt & Equity Classes API Integration Tests', () => {
  ...
  let debtEquityClassService: DebtEquityClassService;
  let customUnitClassService: CustomUnitClassService;
  let testProjectId: string;

  beforeAll(async () => {
    // Initialize services
    projectService = new ProjectService();
    debtEquityClassService = new DebtEquityClassService();
    customUnitClassService = new CustomUnitClassService();
  ...
  describe('PUT /api/debt-equity-classes/:classId', () => {
    ...
    it('should return 400 for validation errors', async () => {
      const invalidUpdateData = {
        unitPrice: -150, // Invalid negative price
        isOpenToInvestments: false
      };
