...
const DebtEquityClass_1 = require("./DebtEquityClass");
describe('DebtEquityClassModel', () => {
    describe('validate', () => {
        ...
        it('should return no errors for valid data', () => {
            const errors = DebtEquityClass_1.DebtEquityClassModel.validate(validClassData);
    ...
    describe('fromFormData', () => {
        it('should transform form data correctly', () => {
            ...
            const result = DebtEquityClass_1.DebtEquityClassModel.fromFormData('project-123', formData);
    ...
    describe('create', () => {
        it('should create a debt equity class with id and timestamps', () => {
            ...
            const result = DebtEquityClass_1.DebtEquityClassModel.create('project-123', classData);
    ...
    describe('update', () => {
        it('should update debt equity class with new timestamp', () => {
            ...
            const result = DebtEquityClass_1.DebtEquityClassModel.update(existingClass, updateData);
...
describe('CustomUnitClassModel', () => {
    describe('validate', () => {
        ...
        it('should return no errors for valid data', () => {
            const errors = DebtEquityClass_1.CustomUnitClassModel.validate(validClassData);
            expect(errors).toEqual([]);
        });
        it('should require name', () => {
            const invalidData = { name: '' };
            const errors = DebtEquityClass_1.CustomUnitClassModel.validate(invalidData);
        ...
        it('should allow valid name patterns', () => {
            ...
            validNames.forEach(name => {
                ...
                const errors = DebtEquityClass_1.CustomUnitClassModel.validate(validData);
                expect(errors).toEqual([]);
            });
        });
    });
    describe('fromFormData', () => {
        it('should transform form data correctly', () => {
            ...
            const result = DebtEquityClass_1.CustomUnitClassModel.fromFormData(formData);
            expect(result).toEqual({
                name: 'Custom Class 1'
            });
        });
    ...
    describe('create', () => {
        it('should create a custom unit class with id and timestamp', () => {
            ...
            const result = DebtEquityClass_1.CustomUnitClassModel.create(classData);
            expect(result.id).toBeDefined();
            expect(result.createdAt).toBeInstanceOf(Date);
...
//# sourceMappingURL=DebtEquityClass.test.js.map